...
const Contact = ({ contact }) => {
  ...
  return (
    <div
      ref={contact}
      className=" items-center justify-center bg-zinc-900 w-full h-screen xl:h-screen
       text-white  py-20"
    >
      <div className="bg-zinc-900 w-full h-auto ">
        ...
        <div className="h-auto items-center justify-center mx-auto w-3/4 lg:w-2/4 flex flex-row py-5 gap-5">
          <a
            className="duration-500 hover:bg-red-500 relative w-64 h-64 bg-zinc-800 border-zinc-800"
            href="https://github.com/alrizkipascar"
            target="_blank"
            rel="noreferrer"
          >
            <div className="absolute inset-0 bg-cover bg-center z-0">
              <img src={git} className=" object-fill w-full h-full"></img>
            </div>
          ...
          >
            <div className="absolute inset-0 bg-cover bg-center z-0">
              <img src={instagram} className=" object-full w-full h-full"></img>
            </div>
            <div className="opacity-0 hover:opacity-100 duration-300 absolute inset-0 z-10 flex justify-center items-center text-5xl text-white font-semibold">
        ...
        <div className="h-auto w-full">
          <div className="h-auto text-2xl font-sans text-zinc-500 mx-auto w-32 h-auto border-t-4  my-8 text-center">
            Contact
            {/* {currentSlide?.index == 0 || currentSlide?.index == 1 ? "About" : currentSlide?.index == 2 ? "Education" : "Certificate"} */}
          </div>
          <div className="h-auto  items-center justify-center mx-auto w-3/4 lg:w-2/4 flex flex-row py-5 gap-5">
            <a
              href="https://www.linkedin.com/in/alrizkipascar/       "
              target="_blank"
              rel="noreferrer"
              className="duration-500 hover:bg-red-500 relative w-64 h-64 bg-zinc-800 border-zinc-800"
            >
            ...
            >
              <div className="absolute inset-0 bg-cover bg-center z-0">
                <img src={email} className=" object-full w-full h-full"></img>
              </div>
              <div className="opacity-0 hover:opacity-100 duration-300 absolute inset-0 z-10 flex justify-center items-center text-5xl text-white font-semibold">
